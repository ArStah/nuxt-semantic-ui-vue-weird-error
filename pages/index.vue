<template>
  <sui-modal closeIcon size="tiny" v-model="open">
    <sui-modal-header>
      Sign up
    </sui-modal-header>
    <sui-modal-content class="scrolling">
      <sui-form>
        <sui-form-field>
          ...
          <sui-input v-model="nickname" placeholder="Nickname" />
        </sui-form-field>
        <sui-form-field>
          <label>Name</label>
          <sui-form-fields :fields="2">
            <sui-form-field>
              <sui-input v-model="name.first" placeholder="Name" />
            </sui-form-field>
            <sui-form-field>
              <sui-input v-model="name.last" placeholder="Surname" />
            </sui-form-field>
          </sui-form-fields>
        </sui-form-field>
        <sui-form-field>
          <label>E-mail</label>
          <sui-input v-model="email.val"
                     type="email"
                     placeholder="E-mail"
          />
        </sui-form-field>
    ...
    <sui-modal-actions style="position: relative">
      <div style="position: absolute; width: 80%; text-align: left;top: 1.8em; left: 2em">
        Already have an account?
        <a href="#sign-in">
          Sign in
        </a>
      </div>
      <sui-button positive icon="chevron right" labelPosition="right">
        Sign up
      </sui-button>
    </sui-modal-actions>
  </sui-modal>
